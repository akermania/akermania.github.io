...
The <a href="https://github.com/akermania/AllSkyX/blob/main/SQM_TSL2591.cpp" style="color:black">.cpp</a> and <a href="https://github.com/akermania/AllSkyX/blob/main/SQM_TSL2591.h" style="color:black">.h</a> files should be at the same location as your .ino file (Arduino code) while compling it.  

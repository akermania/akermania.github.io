...
It is probably possible to build this project without an Arduino, but it will be a big headache simply because the Pi doesn't have analog inputs which will make things more complicated, and also the Arduino libraries are simple to use. Do yourself a favor, these things are cheap, and not only $ wise cheap, but also cheap that they like to stop working for no reason - buy a few so you will have spares.  

<img src="/img/post3_2.jpg" style="width: 400px; margin: auto; display: block;">  
...
<img src="/img/mr-bean-waiting.gif" style="width: 400px; margin: auto; display: block;"> 
...
<img src="/img/post3_3.jpg" style="width: 400px; margin: auto; display: block;">  
